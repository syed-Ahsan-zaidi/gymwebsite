...
export default function MemberSetupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (res.ok && memberResult.id) {
        ...
        if (stripeData.url) {
          // 3. User ko seedha Stripe par bhej dein
  ...
  return (
    <div className="p-10 bg-white rounded-[2.5rem] shadow-2xl max-w-md mx-auto mt-10 border border-gray-100">
      <h2 className="text-4xl font-black mb-6 italic uppercase tracking-tighter text-slate-900">
